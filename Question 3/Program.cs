...
namespace WarehouseInventorySystem
{
    ...
    public class WareHouseManager
    {
        ...
        public void SeedData()
        {
            ...
            _groceries.AddItem(new GroceryItem(1, "Rice (5kg)", 40, DateTime.Now.AddMonths(8)));
            _groceries.AddItem(new GroceryItem(2, "Cooking Oil (1L)", 30, DateTime.Now.AddMonths(6)));
